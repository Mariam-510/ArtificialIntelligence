...
class Input implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (e.getSource() == b1)
        {
            Query q1 = new Query("consult('UninformedSearch.pl')");
            q1.hasSolution();
            ...
            if(Character.compare(lists.charAt(x),']')!=0)
            {
                ...
                num = java.lang.Integer.parseInt(num_dom) ;
            ...
            new Output(M1,N1,lists_updated);
...
class Output {
    ...
    int n = 0;
    int numofBoard = 6;
    Output(int M,int N,Vector<Vector<Character>> vecs)
    {
        JFrame frame = new JFrame();
